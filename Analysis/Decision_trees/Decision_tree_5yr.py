...
plt.savefig("Outputs/Decision_tree/Confusion_matrix_1_5yr.pdf")
...
fig.savefig("Outputs/Decision_tree/decision_tree_CV_5yr.pdf") # Easy to see the graph here

plot_roc_curve(tree_model,X_test,y_test)
plt.savefig("Outputs/Decision_tree/Decision_tree_5yr_ROC.pdf")
...
results.to_csv('Outputs/Decision_tree/results_decision_tree_5yr.csv')
