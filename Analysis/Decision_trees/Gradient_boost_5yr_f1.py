...
parameters = {'loss':['deviance','exponential'],'max_features':['sqrt'], 'n_estimators':[250,500, 1000, 2000],
              'max_depth':range(2,10),'min_samples_leaf':[4,8,16,32,64,128,256,512],
              'learning_rate':[0.1,0.2,0.3,0.6,0.7,0.8], 
...
plt.savefig("Outputs/Gradient_boost/Var_import_5yr_grad_boost.pdf", bbox_inches='tight')
...
shap.summary_plot(shap_values, features = np.array(X_test))
plt.savefig("Outputs/Gradient_boost/Shap_5yr_grad_boost.jpg", bbox_inches='tight')

plot_roc_curve(gb_model,X_test,y_test)
plt.savefig("Outputs/Gradient_boost/Gradient_boost_5yr_ROC.pdf", bbox_inches='tight')
...
plt.savefig("Outputs/Gradient_boost/Confusion_matrix_Grad_5yr.pdf")
...
results.to_csv('Outputs/Gradient_boost/results_grad_boost_5yr.csv')
