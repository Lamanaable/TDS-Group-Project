...
plt.savefig("Outputs/Random_forest/Feature_importance_5yr.pdf", bbox_inches='tight')
...
plt.savefig("Outputs/Random_forest/Shap_plot_5yr.jpg", bbox_inches='tight')

plt.figure()
plt.title('SHAP Density plot for Cases')
shap.summary_plot(shap_values[1], features = np.array(X_test))
plt.savefig("Outputs/Random_forest/Shap_density_5yr.jpg", bbox_inches='tight')
...
plt.savefig("Outputs/Random_forest/Confusion_matrix_2_5yr.pdf")

plot_roc_curve(rf_model,X_test,y_test)
plt.savefig("Outputs/Random_forest/Random_forest_5yr_ROC.pdf")
...
results.to_csv('Outputs/Random_forest/results_random_forest_5yr.csv')
