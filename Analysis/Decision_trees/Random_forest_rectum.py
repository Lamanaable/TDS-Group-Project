...
data = pd.read_csv("/rds/general/project/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Data_exploration/Sensitivity_Data/CRC_rectum_only.csv")
...
plt.savefig("Outputs/Forest_rectum/Feature_importance_rectum.pdf", bbox_inches='tight')
...
plt.savefig("Outputs/Forest_rectum/Shap_plot_rectum.jpg", bbox_inches='tight')

plt.figure()
plt.title('SHAP Density plot for Cases')
shap.summary_plot(shap_values[1], features = np.array(X_test))
plt.savefig("Outputs/Forest_rectum/Shap_density_rectum.jpg", bbox_inches='tight')
...
plt.savefig("Outputs/Forest_rectum/Confusion_matrix_2_rectum.pdf")

plot_roc_curve(rf_model,X_test,y_test)
plt.savefig("Outputs/Forest_rectum/Random_forest_rectum_ROC.pdf")
...
results.to_csv('Outputs/Forest_rectum/results_random_forest_rectum.csv')
