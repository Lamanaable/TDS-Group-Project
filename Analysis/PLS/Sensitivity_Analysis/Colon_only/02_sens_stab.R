...
CRC_ordered <- readRDS('/rds/general/user/wq21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Data_exploration//Sensitivity_Data/CRC_colon_only.rds')
...
saveRDS(stab_sgPLS,'../Outputs/stab_selection_colon.rds')

pdf('../Outputs/stab_selection_colon.pdf')
...
saveRDS(selprop,'../Outputs/stab_selection_colon_selprop.rds')

hat_params=Argmax(stab_sgPLS)
hat_params

pdf('../Outputs/stab_selection_colon_selprop_plot.pdf')
plot(stab_sgPLS)
dev.off()
