...
summary_results
saveRDS(summary_results, "Outputs/lasso_summary.rds")
...
saveRDS(coef_lasso_min, "Outputs/lasso_coefficients_lambdamin.rds")
...
print("Exporting coefficients under lambda min")
saveRDS(coef_lasso_1se, "Outputs/lasso_coefficients_lambda1se.rds")
# 
...
# lasso.prop
# saveRDS(lasso.prop, "Outputs/lasso_stability_lambda1se.rds")
# 
...
print("Running function with 1000 iterations")
niter = 1000
set.seed(1)
...
lasso.prop_min
saveRDS(lasso.prop_min, "Outputs/lasso_stability_lambdamin_1000_iterations.rds")
