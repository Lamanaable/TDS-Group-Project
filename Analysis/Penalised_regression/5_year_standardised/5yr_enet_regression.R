...
jpeg(file="Outputs/enet_5yr_lambda.jpeg")  
plot(model_enet)
dev.off()
...
saveRDS(summary_results, "Outputs/5yr_enet_summary.rds")
...
saveRDS(coef_enet_min, "Outputs/enet_5yr_coefficients_lambdamin.rds")
...
coef_enet_1se
print("Exporting coefficients")
saveRDS(coef_enet_1se, "Outputs/enet_5yr_coefficients_lambda1se.rds")
...
enet.prop
saveRDS(enet.prop, "Outputs/enet_5yr_stability_lambda1se.rds")
...
enet.prop_min
saveRDS(enet.prop_min, "Outputs/enet_5yr_stability_lambdamin.rds")
