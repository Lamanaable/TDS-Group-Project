...
stab<-readRDS("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/5_year_standardised/Outputs/enet_5yr_stability_lambdamin.rds")

pdf("Outputs/stability_enet_lambda_min.pdf", height = 8, width=8)
par(mar=c(12,5,2,4))
