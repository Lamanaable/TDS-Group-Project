...
X_train <- read.csv("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Data/CRC_train_numeric.csv")
X_test <- read.csv("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Data/CRC_test_numeric.csv")
...
# *****HERE SELECTING TO ONLY INCLUDE A SUBSET OF VARIABLES***** -----------------------

X_train <- X_train %>% select(starts_with("Model_"))
ncol(X_train) #Now only 23 variables

X_test <- X_test %>% select(starts_with("Model_"))
ncol(X_test) #Now only 23 variables
...
jpeg(file="Outputs/b_lasso_lambda.jpeg")      
...
summary_results
saveRDS(summary_results, "Outputs/b_lasso_summary.rds")
...
saveRDS(coef_lasso_min, "Outputs/b_lasso_coefficients_lambdamin.rds")
...
print("Exporting coefficients under lambda min")
saveRDS(coef_lasso_1se, "Outputs/b_lasso_coefficients_lambda1se.rds")
...
lasso.prop
saveRDS(lasso.prop, "Outputs/b_lasso_stability_lambda1se.rds")
...
lasso.prop_min
saveRDS(lasso.prop_min, "Outputs/b_lasso_stability_lambdamin.rds")
