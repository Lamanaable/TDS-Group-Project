...
jpeg(file="Outputs/c_enet_lambda.jpeg")  
plot(model_enet)
dev.off()
...
saveRDS(summary_results, "Outputs/c_enet_summary.rds")
...
saveRDS(coef_enet_min, "Outputs/c_enet_coefficients_lambdamin.rds")
...
coef_enet_1se
print("Exporting coefficients")
saveRDS(coef_enet_1se, "Outputs/c_enet_coefficients_lambda1se.rds")
...
enet.prop
saveRDS(enet.prop, "Outputs/c_enet_stability_lambda1se.rds")
...
enet.prop_min
saveRDS(enet.prop_min, "Outputs/c_enet_stability_lambdamin.rds")
