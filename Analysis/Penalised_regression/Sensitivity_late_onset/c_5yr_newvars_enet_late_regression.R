...
X_train <- read.csv("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Sensitivity_late_onset/Data/CRC_5yr_train_late_onset_numeric.csv")
X_test <- read.csv("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Sensitivity_late_onset/Data/CRC_5yr_test_late_onset_numeric.csv")
...
enet.prop_min
saveRDS(enet.prop_min, "Outputs/c_enet_late_5yr_stability_lambdamin.rds")
