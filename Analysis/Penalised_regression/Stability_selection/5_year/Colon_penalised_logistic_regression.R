...
stab<-readRDS("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Stability_selection/5_year/Outputs_colon/stab_selection_lasso_selprop.rds")

# Removing the intercept
#stab<-stab[-1]

length(stab[stab>=0.9]) # 98 variables selected
...
auc_ci
# AUC 
pdf("Outputs_colon/logistic_lasso_auc_stability_selection.pdf")
plot(roc_ROCR, colorize = TRUE)
title(main = "ROC curve: logistic regression colon only - lasso stability selection")
abline(a = 0, b = 1)
