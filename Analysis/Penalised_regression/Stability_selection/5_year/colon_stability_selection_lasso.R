...
print("Reading data")
train <-  readRDS("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Stability_selection/5_year/Data/CRC_colon_train_standardised.rds")
test <- readRDS("/rds/general/user/esb21/projects/hda_21-22/live/TDS/Group_2/TDS-Group-Project/Analysis/Penalised_regression/Stability_selection/5_year/Data/CRC_colon_test_standardised.rds")
...
# Saving lasso plots and Outputs_colon ------------------------------------------


print("Saving stability selection")
saveRDS(stab_lasso,'Outputs_colon/stab_selection_lasso.rds')

print("Calibration plot")
pdf('Outputs_colon/stab_selection_lasso.pdf')
...
saveRDS(selprop,'Outputs_colon/stab_selection_lasso_selprop.rds')
hat_params=Argmax(stab_lasso)
hat_params

print("Stability selection plot")
pdf('Outputs_colon/stab_selection_lasso_selprop_plot.pdf')
par(mar=c(14,5,1,1))
