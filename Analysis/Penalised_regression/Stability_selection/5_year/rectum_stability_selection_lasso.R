...
# Saving lasso plots and Outputs_rectum ------------------------------------------


print("Saving stability selection")
saveRDS(stab_lasso,'Outputs_rectum/stab_selection_lasso.rds')

print("Calibration plot")
pdf('Outputs_rectum/stab_selection_lasso.pdf')
...
saveRDS(selprop,'Outputs_rectum/stab_selection_lasso_selprop.rds')
hat_params=Argmax(stab_lasso)
hat_params

print("Stability selection plot")
pdf('Outputs_rectum/stab_selection_lasso_selprop_plot.pdf')
par(mar=c(14,5,1,1))
