...
## Based on variables selected by Lasso ->90% stable
...
auc_ROCR@y.values[[1]] # AUC of 0.524 using variables >90% stability
...
auc_ci
# AUC is 0.4673-0.5814 (DeLong)

pdf("Outputs/rectum_logistic_lasso_auc_stability_selection.pdf")
