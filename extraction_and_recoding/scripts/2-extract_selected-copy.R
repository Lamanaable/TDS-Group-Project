...
dir.create("../parameters/codings_2", showWarnings = FALSE)
...
choices <- read.xlsx("../parameters/selection_final_2.xlsx")
...
for (i in 1:length(coding_ids)) {
  ...
  write.table(tmp, paste0("../parameters/codings_2/codes_", codeID, ".txt"),
...
write.table(tmp, paste0("../parameters/codings_2/codes_template_continuous.txt"),
  row.names = FALSE, col.names = TRUE
)
...
saveRDS(choices, "../outputs/annot_2.rds")

# Saving extracted dataset
saveRDS(mydata, "../outputs/ukb_extracted_new_2.rds")
